...
"""
    awsecommerceservice.models.offer_listing

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.price
import awsecommerceservice.models.availability_attributes
...
class OfferListing(object):
    ...
    Attributes:
        ...
        price_per_unit (string): TODO: type description here.
        ...
        is_eligible_for_super_saver_shipping (bool): TODO: type description
            here.
        is_eligible_for_prime_free_digital_video (bool): TODO: type
            description here.
    ...
    _names = {
        ...
        "is_eligible_for_prime_free_digital_video" : "IsEligibleForPrimeFreeDigitalVideo",
    ...
    def __init__(self,
                 ...
                 is_eligible_for_prime_free_digital_video=None,
        ...
        self.is_eligible_for_prime_free_digital_video = is_eligible_for_prime_free_digital_video
    ...
    def from_dictionary(cls,
        ...
        price_per_unit = dictionary.get("PricePerUnit")
        price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("Price")) if dictionary.get("Price") else None
        sale_price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("SalePrice")) if dictionary.get("SalePrice") else None
        amount_saved = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("AmountSaved")) if dictionary.get("AmountSaved") else None
        percentage_saved = dictionary.get("PercentageSaved")
        availability = dictionary.get("Availability")
        availability_attributes = awsecommerceservice.models.availability_attributes.AvailabilityAttributes.from_dictionary(dictionary.get("AvailabilityAttributes")) if dictionary.get("AvailabilityAttributes") else None
        is_eligible_for_super_saver_shipping = dictionary.get("IsEligibleForSuperSaverShipping")
        is_eligible_for_prime_free_digital_video = dictionary.get("IsEligibleForPrimeFreeDigitalVideo")
