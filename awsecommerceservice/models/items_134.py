...
"""
    awsecommerceservice.models.items_134

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.request
import awsecommerceservice.models.corrected_query
import awsecommerceservice.models.search_results_map
import awsecommerceservice.models.item_133
import awsecommerceservice.models.search_bin_sets

class Items134(object):

    """Implementation of the 'Items134' model.
    ...
    Attributes:
        ...
        item (list of Item133): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the Items134 class"""
    ...
    def from_dictionary(cls,
        ...
        request = awsecommerceservice.models.request.Request.from_dictionary(dictionary.get("Request")) if dictionary.get("Request") else None
        ...
        search_results_map = awsecommerceservice.models.search_results_map.SearchResultsMap.from_dictionary(dictionary.get("SearchResultsMap")) if dictionary.get("SearchResultsMap") else None
        item = None
        if dictionary.get("Item") != None:
            item = list()
            for structure in dictionary.get("Item"):
                item.append(awsecommerceservice.models.item_133.Item133.from_dictionary(structure))
        search_bin_sets = awsecommerceservice.models.search_bin_sets.SearchBinSets.from_dictionary(dictionary.get("SearchBinSets")) if dictionary.get("SearchBinSets") else None
