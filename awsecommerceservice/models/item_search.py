...
"""
    awsecommerceservice.models.item_search
...
class ItemSearch(object):
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.item_search_request.ItemSearchRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.item_search_request.ItemSearchRequest.from_dictionary(structure))
