...
"""
    awsecommerceservice.models.cart_create

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.cart_create_request

class CartCreate(object):

    """Implementation of the 'CartCreate' model.
    ...
    Attributes:
        ...
        shared (CartCreateRequest): TODO: type description here.
        request (list of CartCreateRequest): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 shared=None,
                 request=None):
        """Constructor for the CartCreate class"""
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.cart_create_request.CartCreateRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.cart_create_request.CartCreateRequest.from_dictionary(structure))
