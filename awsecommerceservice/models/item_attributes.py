...
"""
    awsecommerceservice.models.item_attributes

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.catalog_number_list
import awsecommerceservice.models.creator
import awsecommerceservice.models.ean_list
import awsecommerceservice.models.item_dimensions
import awsecommerceservice.models.languages
import awsecommerceservice.models.price
import awsecommerceservice.models.decimal_with_units
import awsecommerceservice.models.package_dimensions
import awsecommerceservice.models.non_negative_integer_with_units
import awsecommerceservice.models.upc_list
...
class ItemAttributes(object):
    ...
    Attributes:
        ...
        audience_rating (AudienceRatingEnum): TODO: type description here.
        ...
        energy_efficiency_class (string): TODO: type description here.
        ...
        season_sequence (string): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        catalog_number_list = awsecommerceservice.models.catalog_number_list.CatalogNumberList.from_dictionary(dictionary.get("CatalogNumberList")) if dictionary.get("CatalogNumberList") else None
        ...
        if dictionary.get("Creator") != None:
            ...
            for structure in dictionary.get("Creator"):
                creator.append(awsecommerceservice.models.creator.Creator.from_dictionary(structure))
        department = dictionary.get("Department")
        director = dictionary.get("Director")
        ean = dictionary.get("EAN")
        ean_list = awsecommerceservice.models.ean_list.EANList.from_dictionary(dictionary.get("EANList")) if dictionary.get("EANList") else None
        edition = dictionary.get("Edition")
        eisbn = dictionary.get("EISBN")
        energy_efficiency_class = dictionary.get("EnergyEfficiencyClass")
        ...
        item_dimensions = awsecommerceservice.models.item_dimensions.ItemDimensions.from_dictionary(dictionary.get("ItemDimensions")) if dictionary.get("ItemDimensions") else None
        item_part_number = dictionary.get("ItemPartNumber")
        label = dictionary.get("Label")
        languages = awsecommerceservice.models.languages.Languages.from_dictionary(dictionary.get("Languages")) if dictionary.get("Languages") else None
        legal_disclaimer = dictionary.get("LegalDisclaimer")
        list_price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("ListPrice")) if dictionary.get("ListPrice") else None
        magazine_type = dictionary.get("MagazineType")
        manufacturer = dictionary.get("Manufacturer")
        manufacturer_maximum_age = awsecommerceservice.models.decimal_with_units.DecimalWithUnits.from_dictionary(dictionary.get("ManufacturerMaximumAge")) if dictionary.get("ManufacturerMaximumAge") else None
        manufacturer_minimum_age = awsecommerceservice.models.decimal_with_units.DecimalWithUnits.from_dictionary(dictionary.get("ManufacturerMinimumAge")) if dictionary.get("ManufacturerMinimumAge") else None
        ...
        package_dimensions = awsecommerceservice.models.package_dimensions.PackageDimensions.from_dictionary(dictionary.get("PackageDimensions")) if dictionary.get("PackageDimensions") else None
        ...
        season_sequence = dictionary.get("SeasonSequence")
        running_time = awsecommerceservice.models.decimal_with_units.DecimalWithUnits.from_dictionary(dictionary.get("RunningTime")) if dictionary.get("RunningTime") else None
        seikodo_product_code = dictionary.get("SeikodoProductCode")
        size = dictionary.get("Size")
        sku = dictionary.get("SKU")
        studio = dictionary.get("Studio")
        subscription_length = awsecommerceservice.models.non_negative_integer_with_units.NonNegativeIntegerWithUnits.from_dictionary(dictionary.get("SubscriptionLength")) if dictionary.get("SubscriptionLength") else None
        title = dictionary.get("Title")
        track_sequence = dictionary.get("TrackSequence")
        trade_in_value = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("TradeInValue")) if dictionary.get("TradeInValue") else None
        upc = dictionary.get("UPC")
        upc_list = awsecommerceservice.models.upc_list.UPCList.from_dictionary(dictionary.get("UPCList")) if dictionary.get("UPCList") else None
        warranty = dictionary.get("Warranty")
        weee_tax_value = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("WEEETaxValue")) if dictionary.get("WEEETaxValue") else None
