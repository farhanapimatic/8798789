...
"""
    awsecommerceservice.models.similarity_lookup

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.similarity_lookup_request

class SimilarityLookup(object):

    """Implementation of the 'SimilarityLookup' model.
    ...
    Attributes:
        ...
        shared (SimilarityLookupRequest): TODO: type description here.
        request (list of SimilarityLookupRequest): TODO: type description
            here.
    ...
    def __init__(self,
                 ...
                 shared=None,
                 request=None):
        """Constructor for the SimilarityLookup class"""
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.similarity_lookup_request.SimilarityLookupRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.similarity_lookup_request.SimilarityLookupRequest.from_dictionary(structure))
