...
"""
    awsecommerceservice.models.item_lookup
...
class ItemLookup(object):
    ...
    """Implementation of the 'ItemLookup' model.
    ...
    Attributes:
        ...
        shared (ItemLookupRequest): TODO: type description here.
        request (list of ItemLookupRequest): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 shared=None,
                 request=None):
        """Constructor for the ItemLookup class"""
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.item_lookup_request.ItemLookupRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.item_lookup_request.ItemLookupRequest.from_dictionary(structure))
