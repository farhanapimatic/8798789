...
"""
    awsecommerceservice.models.cart_modify

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.cart_modify_request

class CartModify(object):

    """Implementation of the 'CartModify' model.
    ...
    Attributes:
        ...
        shared (CartModifyRequest): TODO: type description here.
        request (list of CartModifyRequest): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 shared=None,
                 request=None):
        """Constructor for the CartModify class"""
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.cart_modify_request.CartModifyRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.cart_modify_request.CartModifyRequest.from_dictionary(structure))
