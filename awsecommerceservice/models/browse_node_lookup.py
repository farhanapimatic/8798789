...
"""
    awsecommerceservice.models.browse_node_lookup

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import awsecommerceservice.models.browse_node_lookup_request

class BrowseNodeLookup(object):

    """Implementation of the 'BrowseNodeLookup' model.
    ...
    Attributes:
        ...
        shared (BrowseNodeLookupRequest): TODO: type description here.
        request (list of BrowseNodeLookupRequest): TODO: type description
            here.
    ...
    def __init__(self,
                 ...
                 shared=None,
                 request=None):
        """Constructor for the BrowseNodeLookup class"""
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.browse_node_lookup_request.BrowseNodeLookupRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.browse_node_lookup_request.BrowseNodeLookupRequest.from_dictionary(structure))
