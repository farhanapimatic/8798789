...
"""
    awsecommerceservice.models.collection_summary
...
class CollectionSummary(object):
    ...
    def from_dictionary(cls,
        ...
        lowest_list_price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("LowestListPrice")) if dictionary.get("LowestListPrice") else None
        highest_list_price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("HighestListPrice")) if dictionary.get("HighestListPrice") else None
        lowest_sale_price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("LowestSalePrice")) if dictionary.get("LowestSalePrice") else None
        highest_sale_price = awsecommerceservice.models.price.Price.from_dictionary(dictionary.get("HighestSalePrice")) if dictionary.get("HighestSalePrice") else None
