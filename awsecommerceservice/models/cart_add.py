...
"""
    awsecommerceservice.models.cart_add
...
class CartAdd(object):
    ...
    """Implementation of the 'CartAdd' model.
    ...
    Attributes:
        ...
        shared (CartAddRequest): TODO: type description here.
        request (list of CartAddRequest): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 shared=None,
                 request=None):
        """Constructor for the CartAdd class"""
    ...
    def from_dictionary(cls,
        ...
        shared = awsecommerceservice.models.cart_add_request.CartAddRequest.from_dictionary(dictionary.get("Shared")) if dictionary.get("Shared") else None
        request = None
        if dictionary.get("Request") != None:
            request = list()
            for structure in dictionary.get("Request"):
                request.append(awsecommerceservice.models.cart_add_request.CartAddRequest.from_dictionary(structure))
