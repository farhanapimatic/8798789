...
result = awse_commerce_service_binding_controller.create_item_lookup(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup(body)
...
result = awse_commerce_service_binding_controller.create_cart_get(body)
...
result = awse_commerce_service_binding_controller.create_cart_add(body)
...
result = awse_commerce_service_binding_controller.create_cart_create(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear(body)
...
result = awse_commerce_service_binding_controller.create_item_search_9(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_10(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_11(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_12(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_13(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_14(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_15(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_16(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_17(body)
...
result = awse_commerce_service_binding_controller.create_item_search_18(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_19(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_20(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_21(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_22(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_23(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_24(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_25(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_26(body)
...
result = awse_commerce_service_binding_controller.create_item_search_27(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_28(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_29(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_30(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_31(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_32(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_33(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_34(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_35(body)
...
result = awse_commerce_service_binding_controller.create_item_search_36(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_37(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_38(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_39(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_40(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_41(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_42(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_43(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_44(body)
...
result = awse_commerce_service_binding_controller.create_item_search_45(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_46(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_47(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_48(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_49(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_50(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_51(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_52(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_53(body)
...
result = awse_commerce_service_binding_controller.create_item_search_54(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_55(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_56(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_57(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_58(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_59(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_60(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_61(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_62(body)
...
result = awse_commerce_service_binding_controller.create_item_search_63(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_64(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_65(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_66(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_67(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_68(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_69(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_70(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_71(body)
...
result = awse_commerce_service_binding_controller.create_item_search_72(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_73(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_74(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_75(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_76(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_77(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_78(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_79(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_80(body)
...
result = awse_commerce_service_binding_controller.create_item_search_81(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_82(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_83(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_84(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_85(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_86(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_87(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_88(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_89(body)
...
result = awse_commerce_service_binding_controller.create_item_search_90(body)
...
result = awse_commerce_service_binding_controller.create_item_lookup_91(body)
...
result = awse_commerce_service_binding_controller.create_browse_node_lookup_92(body)
...
result = awse_commerce_service_binding_controller.create_similarity_lookup_93(body)
...
result = awse_commerce_service_binding_controller.create_cart_get_94(body)
...
result = awse_commerce_service_binding_controller.create_cart_add_95(body)
...
result = awse_commerce_service_binding_controller.create_cart_create_96(body)
...
result = awse_commerce_service_binding_controller.create_cart_modify_97(body)
...
result = awse_commerce_service_binding_controller.create_cart_clear_98(body)
